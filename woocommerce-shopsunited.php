 ...
 *
 * @wordpress-plugin
 * Plugin Name:     Shops United for WooCommerce
 * Plugin URI:      https://shops-united.nl/koppelingen/woocommerce/
 * Description:     Geef klanten de mogelijkheid om hun pakket af te halen bij een afhaalpunt in de buurt. Daarnaast exporteert de plug-in uw zendingen direct in het verzendsysteem van Shops United.
 * Version:         1.9.0
 * Author:          Shops United
 * Author URI:      https://shops-united.nl/
 * License:         GPL-3.0+
 * License URI:     http://www.gnu.org/licenses/gpl-3.0.txt
 * Text Domain:     integration-shops-united-woocommerce
 */
...
define('PARCELPRO_NAME', 'WooCommerce Shops United');
...
define('PARCELPRO_SHOPSUNITED', 'Shops United');
